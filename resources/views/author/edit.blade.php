   ...
   <div class="relative h-92 flex content-start flex-wrap m-auto lg:w-8/12 xl:w-6/12 sm:w-10/12 mt-10 bg-gray-100">
      ...
      <table class="m-auto w-11/12  ">
         ...
         <form method="POST" action="{{route('author.update',[$author->id])}}">
            <td><input type="text" name="author_name" value="{{$author->name}}"></td>
         </tr>
         <tr class="h-12 text-xl border-solid   border-gray-500 border-2">
            <td>
               <p>Pavardė:</p>
         ...
         <button class="bg-gray-600 hover:bg-gray-400 text-gray-100 w-auto h-auto m-1 p-3  rounded-full mt-12 absolute top-48 right-0 " type="submit">Taisyti</button>
         </form>
