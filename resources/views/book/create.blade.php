...
<body class="bg-gray-100">
    ...
    <div class=" h-92 flex content-start flex-wrap m-auto lg:w-8/12 xl:w-6/12 sm:w-10/12 mt-10 bg-gray-100">
        <a class="text-2xl sm:text-3xl m-auto py-6 ">Predti knygą</a>
        <table class="m-auto w-11/12  ">
            ...
            <tr class="h-12 text-xl border-solid   border-gray-500 border-2 ">
                ...
                <form method="POST" action="{{route('book.store')}}">
                    <td><input class="w-7/12" type="text" name="book_title"></td>
            </tr>
            ...
            <tr class="h-12 text-xl border-solid   border-gray-500 border-2">
                ...
                <td>
                    <input class="w-7/12" type="text" name="book_isbn">
                </td>
            </tr>
            ...
            <tr class="h-12 text-xl border-solid   border-gray-500 border-2">
                ...
                <td>
                    <input class="w-7/12" type="text" name="book_pages"> </td>
            </tr>
            ...
            <tr class="h-12 text-xl border-solid   border-gray-500 border-2">
                ...
                <td>
                    <textarea class="w-7/12" name="book_about"></textarea>
            </tr>
            <br>
